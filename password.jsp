...
<br>
   New Password<br>
  <form:input type="password" path="password" class="form-control" id="txtPassword" required="required" />
   
  <br>
  <div class="form-group">
	<label ><font size="4">Confirm Password</font></label>
	<input name="confirmPassword" type="password" class="form-control" id="txtConfirmPassword" required="required"/>
</div>
